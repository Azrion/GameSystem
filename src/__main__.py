    ...
    while True:
        ...
        if len(clusterA) != 0:
            ...
            minCoordinatesClusterA = closestContour(clusterA, minCoordinatesClusterA,
                                                    ptcCoordinates, skipIdx, minDistanceA)
        ...
        if multiTouch:
            if len(clusterB) != 0:
                ...
                minCoordinatesClusterB = closestContour(clusterB, minCoordinatesClusterB,
                                                        ptcCoordinates, skipIdx, minDistanceB)
...
def multiprocess(pList, skipIdx):
    """
    :param pList: array of generated game object particles
    :param skipIdx: multi touch index
    """
    q1 = Queue()
    q2 = Queue()
...
if __name__ == "__main__":
    particlesList, sIdx = spawn(particleSpawnPos, particleSpawnVel, particleSpawnAngle)  # Spawn game object particles
